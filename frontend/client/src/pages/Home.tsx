...
const ASSETS = {
  ...
  office_interior: "/assets/EV_Investment_office.png",
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-main-black text-main-mist font-sans">
        ...
        <div className="container flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] font-mono-tech tracking-[0.3em] text-main-accent-t1 uppercase">Quy Nhon Fund</span>
            </div>
          </div>

          <nav className="hidden md:flex items-center gap-8 font-mono-tech text-xs tracking-widest uppercase">
            <a href="#hero" className="hover:text-main-accent-t1 transition-colors">Home</a>
            <a href="#portfolio" className="hover:text-main-accent-t1 transition-colors">Portfolio</a>
            <a href="#calculator" className="hover:text-main-accent-t1 transition-colors">Terminal</a>
            <a href="#research" className="hover:text-main-accent-t1 transition-colors">Research</a>
            <a href="#team" className="hover:text-main-accent-t1 transition-colors">Team</a>
          </nav>
        ...
        <div className="container relative z-10 text-center flex flex-col items-center justify-center h-full max-w-4xl px-4">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-serif-display font-light text-white leading-tight mb-6">
              Invest in <span className="italic text-main-accent-t1">Quy Nhon</span><br />
      ...
      <section id="portfolio" className="py-24 relative border-t border-main-mist/10">
        <div className="container">
          
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
            <div>
              <span className="text-xs font-mono-tech text-main-accent-t1 tracking-[0.3em] uppercase block mb-3">Investment Scope</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div id="calculator" className="md:col-span-2 border border-main-mist/10 bg-main-card p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <section id="research" className="research-texture py-24 text-main-mist relative overflow-hidden border-y border-main-mist/10">
        <div className="container relative z-10">

          <div className="max-w-3xl mb-16">
            <span className="text-xs font-mono-tech text-main-accent-t1 tracking-[0.3em] uppercase block mb-3">Academic Rigor</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-4">
              {[
                ...
                >
                  <span className="text-[10px] font-mono-tech text-main-accent-t1 uppercase tracking-widest block mb-2">{report.cat}</span>
